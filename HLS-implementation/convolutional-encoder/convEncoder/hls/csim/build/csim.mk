...
HLS_SOURCES = ../../../../convEncoder_Seq_tb.cpp ../../../../convEncoder_Seq.cpp
...
$(ObjDir)/convEncoder_Seq_tb.o: ../../../../convEncoder_Seq_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../convEncoder_Seq_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/convEncoder_Seq_tb.d

$(ObjDir)/convEncoder_Seq.o: ../../../../convEncoder_Seq.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../convEncoder_Seq.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=convEncoder_Seq $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/convEncoder_Seq.d
