...
set ip_vlnv xilinx.com:hls:convEncoder_Seq:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project convEncoder
...
dict set report_options topmodule "convEncoder_Seq"
dict set report_options funcmodules convEncoder_Seq_convEncoder_Seq_Pipeline_VITIS_LOOP_40_1
dict set report_options bindmodules {convEncoder_Seq_bitselect_1ns_32ns_5ns_1_1_1 convEncoder_Seq_partset_64ns_64ns_2ns_6ns_64_1_1 convEncoder_Seq_flow_control_loop_pipe_sequential_init}
