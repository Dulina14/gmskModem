...
IFLAG += -DNT
LFLAG += -Wno-macro-redefined -Wl,--stack,0x40000000
LFLAG += -lpthread
...
$(ObjDir)/convEncoder_Seq_tb.cpp_pre.cpp.tb.o : convEncoder_Seq_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling convEncoder_Seq_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/convEncoder_Seq.cpp_pre.cpp.tb.o : convEncoder_Seq.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling convEncoder_Seq.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
