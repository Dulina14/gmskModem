...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "convEncoder_Seq.autotvin.dat"
	set constFileTvOut       "convEncoder_Seq.autotvout.dat"
	set constFileHdlTvIn     "convEncoder_Seq.autohdltvin.dat"
	set constFileHdlTvOut    "convEncoder_Seq.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
