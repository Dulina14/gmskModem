...
if {[file isfile convEncoder_Seq.autotvin.dat]} {
	file delete -force convEncoder_Seq.autotvin.dat
}

if {[file isfile convEncoder_Seq.autotvout.dat]} {
	file delete -force convEncoder_Seq.autotvout.dat
}
