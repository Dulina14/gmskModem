...
HD_PWD='D:/vivado/throughput_zybo/throughput_zybo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log throughput_bench_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source throughput_bench_top.tcl
