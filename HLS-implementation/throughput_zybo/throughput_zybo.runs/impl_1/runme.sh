...
HD_PWD='D:/vivado/throughput_zybo/throughput_zybo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log throughput_bench_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source throughput_bench_top.tcl -notrace
